...
function Github(){
    return(
        <svg onClick={() => window.open('https://github.com/hliwudnew', "_blank")} className="Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 -0.5 16 16" shape-rendering="crispEdges">
